        ...
        <html>
			...
			<div class="text" style="color: #666666; float: right; margin-top: 20px; margin-bottom: 20px; margin-right: 120px;">
				...
				<table border="1" style="  width: 95%; ">
					...
					<tr>
						<td colspan="18" style="padding: 0; border-left: 2px solid #DAA520; border-right: 2px solid #DAA520;"><h4  class="marketplace-header">Исполненные сделки:</h4></td>
					</tr>
					...
					<tr>
						<td colspan="18" style="padding: 0; border-left: 2px solid #DAA520; border-right: 2px solid #DAA520;"><h4  class="marketplace-header">Незавершенные сделки к исполнению:</h4></td>
					</tr>
